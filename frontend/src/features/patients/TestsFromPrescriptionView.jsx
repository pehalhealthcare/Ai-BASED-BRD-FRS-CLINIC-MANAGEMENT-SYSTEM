            ...
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[9px] font-black text-blue-700 bg-blue-100 px-1.5 py-0.5 rounded-full uppercase">New</span>
                </div>
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-1.5 mt-0.5">
                            ...
                            <span className={`text-[8px] font-black px-1.5 py-0.2 rounded uppercase ${
                              isUploaded ? 'bg-purple-100 text-purple-800' : 'bg-blue-100 text-blue-800'
                            }`}>
                                ...
                                <tr key={test.id} className="hover:bg-white/80 transition duration-150">
                                  <td className="py-3.5 px-4">
                                    <div>
                                      ...
                                      <span className="inline-block mt-1 text-[8px] font-black text-blue-700 bg-blue-50 border border-blue-200/60 px-1.5 py-0.5 rounded uppercase">
                                        CLINIC LABORATORY
                                      </span>
                                    </div>
                                  </td>
                                  ...
                                  <td className="py-3.5 px-4 whitespace-nowrap">
                                    {test.isBooked ? (
                                      ...
                                      <span className="inline-flex items-center gap-1 text-[9px] font-black text-blue-700 bg-blue-50 border border-blue-200 px-2 py-0.5 rounded-full uppercase">
        ...
        <div id="how-it-works-sidebar" className="lg:col-span-4 space-y-6">
          <div className="bg-white border border-slate-200 rounded-3xl p-6 shadow-sm space-y-5">
            ...
            <div className="space-y-4 relative before:absolute before:left-3.5 before:top-3 before:bottom-3 before:w-0.5 before:bg-slate-100">
              ...
              <div className="flex items-start gap-3 relative">
                <div className="w-7 h-7 rounded-full bg-blue-50 border border-blue-200 text-blue-700 text-xs font-black flex items-center justify-center shrink-0 z-10">3</div>
                <div>
                  ...
                  <div key={test.testId} className={`p-4 rounded-2xl border transition-all ${test.selected ? 'bg-blue-50/40 border-blue-200 shadow-2xs' : 'bg-white border-slate-200 opacity-60'}`}>
                    <div className="flex items-start justify-between gap-3">
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-2 mt-1">
                            {test.confidence === 'HIGH' ? (
                              <span className="inline-flex items-center gap-1 text-[9px] font-black text-blue-700 bg-blue-50 border border-blue-200 px-1.5 py-0.5 rounded"><Check size={10} /> Matched with Global Catalogue</span>
                            ) : (
                      ...
                      <div className="text-right shrink-0">
                        ...
                        <p className={`text-[9px] font-bold mt-0.5 ${test.isAvailable ? 'text-blue-600' : 'text-rose-600'}`}>{test.isAvailable ? 'Available at Lab' : 'Not Available'}</p>
                      </div>
                    </div>
                  </div>
                ))}
          ...
          <div className="w-full max-w-lg bg-white h-full shadow-2xl flex flex-col justify-between overflow-hidden">
            ...
            <div className="p-6 overflow-y-auto space-y-6 flex-1">
              <div className="flex items-center justify-between p-4 rounded-2xl bg-slate-50 border border-slate-200/80">
                ...
                <div>
                  <span className={`text-[10px] font-black px-2.5 py-1 rounded-full uppercase ${selectedTestForDetails.isAvailable ? 'bg-blue-100 text-blue-800' : 'bg-rose-100 text-rose-800'}`}>
          ...
          <div className="w-full max-w-xl bg-white h-full shadow-2xl flex flex-col justify-between overflow-hidden">
            ...
            <div className="p-6 overflow-y-auto space-y-6 flex-1">
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button type="button" onClick={() => setCollectionMethod('AT_LAB')} className={`p-4 rounded-2xl border text-left transition-all ${collectionMethod === 'AT_LAB' ? 'border-blue-600 bg-blue-50/50 shadow-xs ring-2 ring-blue-600/10' : 'border-slate-200 bg-white hover:bg-slate-50'}`}>
                    <div className="flex items-center justify-between"><Building2 size={18} className="text-blue-600" /><span className="text-[9px] font-black text-blue-700 bg-blue-100 px-1.5 py-0.5 rounded">FREE</span></div>
              ...
              <div className="space-y-2">
                ...
                {appliedPromo ? (
                  <div className="flex items-center justify-between p-3 rounded-2xl bg-blue-50 border border-blue-200 text-blue-900">
                    <div className="flex items-center gap-2">
                      <Tag size={15} className="text-blue-600" />
                      <div>
                        <p className="text-xs font-black">{appliedPromo.code} Applied</p>
                        <p className="text-[10px] text-blue-700">Discount: -₹{appliedPromo.discountAmount}</p>
                      </div>
                    </div>
      ...
      {orderSuccessModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs animate-fade-in">
          <div className="bg-white rounded-3xl p-8 max-w-md w-full text-center space-y-5 shadow-2xl border border-slate-200">
            <div className="w-16 h-16 rounded-full bg-blue-50 border border-blue-200 text-blue-600 flex items-center justify-center mx-auto shadow-sm"><CheckCircle size={32} /></div>
            <div className="space-y-1">
