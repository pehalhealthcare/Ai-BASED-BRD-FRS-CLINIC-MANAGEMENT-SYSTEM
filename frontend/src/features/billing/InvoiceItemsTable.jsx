const FIELD_CLASS =
  'w-full rounded-2xl border border-stone-300 px-3 py-2 text-sm outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-100 text-white';
