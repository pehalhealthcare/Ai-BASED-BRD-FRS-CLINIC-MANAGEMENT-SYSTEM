...
DEPARTMENT_RULES = [
    ...
    ("broken leg", "Orthopedics", "Bone fractures or severe limb injuries need orthopedics evaluation."),
    ("broken", "Orthopedics", "Bone fractures or severe limb injuries need orthopedics evaluation."),
    ("fracture", "Orthopedics", "Bone fractures or severe limb injuries need orthopedics evaluation."),
    ("bone break", "Orthopedics", "Bone fractures or severe limb injuries need orthopedics evaluation."),
